...
## 출시 로드맵
- M1 (1-2개월): Printful 단일 통합 + Apparel 프리셋
- M2 (3-4개월): 멀티 프리셋 + 마진 시뮬레이터, 결제 도입
- M3 (5-6개월): Shopify/Etsy 멀티채널 동시 등록
- M4 (7-9개월): A/B 가격 테스트, 화이트라벨, 에이전시 플랜
- M5 (10-12개월): AI 자동 mockup/태그 추천 (Claude 활용)
